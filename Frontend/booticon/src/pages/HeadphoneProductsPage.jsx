...
function HeadphoneProductsPage() {
    ...
    useEffect(() => {
        // Fetch products
        let url = 'https://localhost:7023/api/Category/5';
        if (selectedBrand) {
            url = `https://localhost:7023/api/Filter/FilterForCategoryAndBrand?categoryId=5&brandId=${selectedBrand}`;
        }
        axios.get(url)
            .then(response => {
...
export default HeadphoneProductsPage