...
function MouseProductsPage() {
    ...
    useEffect(() => {
        // Fetch products
        let url = 'https://localhost:7023/api/Category/2';
        if (selectedBrand) {
            url = `https://localhost:7023/api/Filter/FilterForCategoryAndBrand?categoryId=2&brandId=${selectedBrand}`;
        }
        axios.get(url)
            .then(response => {
...
export default MouseProductsPage