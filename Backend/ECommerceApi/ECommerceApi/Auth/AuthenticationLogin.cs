...
namespace ECommerceApi.Auth
{
    public class AuthenticationLogin
    {
        ...
        public AuthenticationLogin(UserManager<AppUser> userManager, IConfiguration configuration)
        {
        ...
        private ClaimsPrincipal GetPrincipalFromExpiredToken(string token)
        {
            ...
            {
                ValidateIssuer = true, // bu key kim ürettiyse doğrulamak istediğimi söylüyorum
                ValidateAudience = true,// geçerli bir alıcı mı doğrula
                ValidateLifetime = true, // geçerlilik süresi doğrula
                ValidateIssuerSigningKey = true, // anahtar için sign key ifadesini doğrular
            ...
            var principal = tokenHandler.ValidateToken(token, tokeValidationParameters, out securityToken);
